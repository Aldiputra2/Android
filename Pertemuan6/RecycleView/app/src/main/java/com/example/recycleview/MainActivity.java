...
private ArrayList<Hmj>list=new ArrayList<>();
    ...
    if (getSupportActionBar()!=null){
        getSupportActionBar().setTitle("Himpunan IT Telkom Purwokerto");
        }
    ...
    public ArrayList<Hmj>getListHmj(){
        String[]data =getResources().getStringArray(R.array.data_name);
        String[] kopet =getResources().getStringArray(R.array.data_description);
